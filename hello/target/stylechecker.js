...
export var do_it = function (event) {
	...
	style_summ.files = [];
	for (var single_file of document.getElementsByClassName ('textarea.fileText')) {
		var src_file = SrcFile ();
		var __left0__ = document.getElementById (single_file.id + 'Name').value;
		src_file.filename = __left0__;
		var single_file_name = __left0__;
